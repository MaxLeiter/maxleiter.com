...
const talks = [
    { description: 'A great channel for humorous in-depth explanations on N64 hacking and emulations.', url: 'https://www.youtube.com/watch?v=t_rzYnXEQlE' },
    ...
    { description: 'The creator of JSON (although he would argue "discoverer") walks you through many of original ideas and reasonings behind the JSON language. My personal favorite in this list, I think.', url: 'https://www.youtube.com/watch?v=-C-JoyNuQJs' },
    ...
    { description: 'A brilliant introduction to the BEAM virtual machine and it\'s capabilities. ', url: 'https://www.youtube.com/watch?v=JvBT4XBdoUE' },
    ...
    { description: 'It\'s frankly terrifying the length to which North Korea has gone to spy on their citizens. Possibly my favorite talk on this page.', url: 'https://www.youtube.com/watch?v=8LGDM9exlZw' },
    { description: 'Dylan Beattie is the best conference speaker I\'ve seen, and I feel like this is his best talk (it\'s definitely his most popular). In this, Beattie explores why code is beautiful, and he show\'s examples too.', url: 'https://www.youtube.com/watch?v=6avJHaC3C2U' },
