---
title: Why your website's fonts might be larger than you want on mobile
description: A well-meaning iOS feature can be problematic
...
<img
  src="/blog/ios-font-size/bug.jpg"
  alt={
