...
Obviously, we'll see an increase in vendoring and in-house agentic-rewrites ("slop forks"[^2]). We're already seeing this: Bun [autonomously rewrote from Zig to Rust](https://bun.com/blog/bun-in-rust)
