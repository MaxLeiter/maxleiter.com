...
As we started playing the <abbr title="highly curated collection of 200+ mods">Divine Journey 2</abbr> modpack,
...
<details>
  ...
  Actually Additions, Draconic Additions, Draconic Evolution, Ender IO, Extra
  Utilities 2, Extreme Reactors, Galacticraft Core, Galacticraft Planets,
  Immersive Engineering, Industrial Foregoing, Integrated Dynamics,
  LightningCraft, RFTools, RFTools Dimensions, Thaumcraft, Thaumic Augmentation.
</details>
}

![Screenshot of the generators from Just Enough Items](/blog/vibecoding-mc/generators.png)

Finding them around our base was a pain. My friends knew where everything was, and would be telling me things like
"put coal in the hopper that feeds the Coke Oven into the Blast Furnace by the biodiesel setup"

There's one obvious solution:

## The Solution: more mods

I ended up creating two mods with a mix of [OpenAI Codex](https://github.com/openai/codex) (the cli), [Claude Code](https://www.anthropic.com/claude-code), and [Cursor](https://www.cursor.com/):
...
<p>
You can bind a keybind to open a UI to filter and search for specific blocks:
...
<p>
  ...
  suggested using something like JIRA. That's when you know its bad. In their
  defense, they didn't know about Linear yet.
</p>
...
<video controls width={400} height={400} autoPlay muted loop>
