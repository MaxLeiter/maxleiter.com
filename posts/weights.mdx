...
"Matrix multiplication did that. The numbers go in one end, the tactful phrasing comes out the other."
...
"Nope. We thought of that, since they do know things. But we probed them. The knowledge is weights too. Smeared across all eighty layers. We tried to point to Paris. You can't point to Paris. It's weights all the way down."
