...
Another example of this is when gpt-5 was released in Cursor. People _hated_ it, but the zeitgeist has since shifted.
You can read about what OpenAI and Cursor fixed in [OpenAI's gpt-5 cookbook](https://cookbook.openai.com/examples/gpt-5/gpt-5_prompting_guide?utm_source=chatgpt.com#collaborative-coding-in-production-cursors-gpt-5-prompt-tuning).
