...
how to use the new features and React Server Components, so I thought I'd share an outline on how I built this website,
which makes use of many new features.
