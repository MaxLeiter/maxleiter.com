...
![](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/header.png)
...
You can try it out [here](https://sandcastle-os.vercel.app), and the source is available [here](https://github.com/vercel-labs/sandcastle).
...
![](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/kde.png)

Here's [Sway](https://swaywm.org/):

![](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/sway.png)
...
![A screenshot of Sandcastle showing xeyes, GIMP, and a file explorer](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/sandcastle.png)
...
![](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/files.png)

But it also runs X11 applications and streams them to the browser:

![](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/x11-apps.png?w=800)
...
Unless you live in a cave, if you clicked on this post you've likely heard of the terminal emulator [Ghostty](https://ghostty.org/).
...
![A screenshot of gnome-calculator with two stacked window decorations: mine and GNOME's](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/double-dec.png?w=200)
  ...
  <li>
    ...
    <ul>
      ...
      <li>
        ...
        reads. When the value changes, it emits a <code>SettingChanged</code> D-Bus signal, and GTK apps
...
<video controls height="400" width="600">
  <source src="https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/responsive.webm" type="video/webm" />
</video>
<figcaption>
...
![A screenshot of VS Code with 6 terminals open: one for the dev server, one for Codex, four for OpenCode](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/sandcastle/ide.png)
...
One thing that let me iterate quickly here was the [Sandbox CLI](https://vercel.com/changelog/vercel-sandbox-cli-is-now-available). My agents were able to spin up sandboxes, mess around with the underlying linux box, and use that knowledge in their code.
