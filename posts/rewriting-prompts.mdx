...
In other words, prompting isn't just about telling the model what to do, but about aligning (or fighting) with the models defaults, and every model has its own defaults.
