...
const Home = () => (
  <div className="container">
    <Head>
      ...
      <meta name="keywords" content="Max,Leiter,Max Leiter, X11, iOS, Linux, Xorg, Cydia, jailbreak, X11 on iOS" />
    </Head>
    ...
    <main>
      ...
      <p className="section">
        I'm excited to announce that X11 is coming soon to iOS. Most (see below) packages and dependencies for a fully functioning X11 desktop system have been compiled and are available on Cydia for iOS 11+. All packages have been compiled for arm64 and have been tested on iOS 12.4 and iOS 13.1. <b>This requires a jailbroken device.</b>
      </p>
      <p className="section">
      ...
      <a className="buttonLink section" href="cydia://url/https://cydia.saurik.com/api/share#?source=https://maxleiter.com/cydia"><button className="cydia">Add to Cydia</button></a>
      
      <img className="image section" src="https://maxleiter.com/X11/front.png" alt="running on device" async="on" />
      <i>Above: adie (text editor), glxgears (GL demo), xterm (terminal emulator), fluxbox (window manager), compton (compositor), PathFinder (files).</i>

      <a href="./onipad.jpg" className="section">Image of programs running on device</a>
      ...
      <p className="section">
        <Link href="/X11/instructions"><a>On a separate page</a></Link>
      </p>
    </main>
    <footer>
      <span>By <Link href="/"><a>Max Leiter</a></Link></span><a href="https://github.com/MaxLeiter" alt="Source for this page">This site on GitHub</a>
    </footer>
    <style jsx>{`
      .container {
        min-height: 100vh;
