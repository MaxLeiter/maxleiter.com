 ...
 *
 * `framework/vercel.ts` translates the rules below into Build Output API
 * routes, `framework/dev.ts` interprets them to serve locally, and
 ...
 * it unbundled (bun, or node's type stripping) as `../framework/routing.ts`.
 */
