...
import { renderBody, renderPartial, renderShell, type Fonts } from './shell'
import { resetArticleImages } from '../../app/mdx/static-components'

/**
 * The server bundle's entry point.
 *
 * esbuild bundles this file and everything it reaches into one module, which
 ...
 *
 * The registry it loops over is `./pages.ts`. Keeping the entry point separate
 * from the registry is honest about what esbuild actually bundles.
 *
