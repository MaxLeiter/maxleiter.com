 ...
 *
 * The build-side interface every other framework module imports. The
 * client-safe half of the content model lives in `app/lib/types.ts`, because
 * the islands import it and nothing they reach may pull in `node:fs`.
 *
...
/** What `framework/render/index.ts` exports. */
