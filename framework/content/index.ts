...
import type { ListEntry, ProjectCard } from '../../app/lib/types'
import type { BuildContext, Note, Post, Project, Site } from '../shared/types'
...
/** The loaded record flattened into the card the pages and the island render. */
...
/**
 * One flat, date-sorted list of local posts, external posts and notes, which is
 * what /blog, the homepage and the desktop island render.
 */
