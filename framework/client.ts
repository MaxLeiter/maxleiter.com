  ...
  for (const name of names) {
    ...
    await fs.writeFile(
      ...
      [
        ...
        '',
        '// Returns its own teardown: the router unmounts every island before',
        '// it replaces the body, so listeners an island registered on window',
        '// or document do not accumulate one set per navigation.',
