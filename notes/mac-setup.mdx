...
- [BetterTouchTool](https://folivora.ai/) allows advanced customization of the touchbar  ($9 after 45 days)
    ...
    ![Image of the GoldenChaos touchbar layout](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/macos/touchbar.jpg)
...
- [Rectangle](https://rectangleapp.com/) lets you resize and snap windows with your keyboard
    ![Image of the Rectangle settings showing it has many options](https://tddeuevmbjbaaeoi.public.blob.vercel-storage.com/blog/macos/rectangle.jpg)
