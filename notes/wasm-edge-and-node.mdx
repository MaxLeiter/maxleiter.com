---
title: Loading wasm files on Vercel Edge and Node functions
slug: wasm-edge-and-node
date: Mar 30, 2024
---

Loading wasm on [Vercel Edge runtime](https://vercel.com/docs/functions/wasm) is easy. You need to do a little more work
